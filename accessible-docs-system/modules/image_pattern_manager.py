...
class ImagePatternManager:
    ...
    def _load_default_patterns(self):
        ...
        if count == 0:
            default_patterns = [
                ("figura", r'Fig\.?\s*(\d+\.?\d*[a-z]?)', 100, "Figura standard (Fig, Fig.)"),
                ("figura_estesa", r'Figura\.?\s*(\d+\.?\d*[a-z]?)', 95, "Figura scritta per esteso"),
                ("figure_en", r'Figure\.?\s*(\d+\.?\d*[a-z]?)', 90, "Figure in inglese"),
                ("immagine", r'Immagine\.?\s*(\d+\.?\d*[a-z]?)', 85, "Immagine"),
                ("grafico", r'Grafico\.?\s*(\d+\.?\d*[a-z]?)', 80, "Grafico"),
                ("tabella", r'Tab\.?\s*(\d+\.?\d*[a-z]?)', 75, "Tabella abbreviata"),
                ("tabella_estesa", r'Tabella\.?\s*(\d+\.?\d*[a-z]?)', 70, "Tabella per esteso"),
                ("esempio", r'Esempio\.?\s*(\d+\.?\d*[a-z]?)', 65, "Esempio"),
                ("didascalia", r'Didascalia\.?\s*(\d+\.?\d*[a-z]?)', 60, "Didascalia"),
                ("schema", r'Schema\.?\s*(\d+\.?\d*[a-z]?)', 55, "Schema"),
                ("diagramma", r'Diagramma\.?\s*(\d+\.?\d*[a-z]?)', 50, "Diagramma"),
            ]
            ...
            conn.commit()
            print(f"✓ Caricati {len(default_patterns)} pattern di default")
